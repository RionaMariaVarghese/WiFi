...
class TutorialPage(QWidget):
    ...
    def show_initial_page(self):
        ...
        tutorial_label.setStyleSheet("font-size: 40px; letter-spacing: 10px; font-weight: bold; color: #feb32b;")
        ...
        self.add_paragraph("Welcome to the <span>Tutorials</span> Section. This is where you will be learning what WiFi is, what tools are available to perform an WiFi attacks and how can you prevent them from happening. It is advised to complete this section first in order to answer the questions provided in the <span>Levels</span> Section.", inner_layout)
